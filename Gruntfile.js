...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    coffee: {
      dist: {
        files: {
          '.tmp/scripts/coffee.js': '<%= yeoman.assets.javascripts %>/**/*.coffee'
        }
      },
      test: {
        files: [{
    ...
    requirejs: {
      dist: {
        ...
        options: {
          ...
          mainConfigFile: '<%= yeoman.assets.javascripts %>/application.js'
        }
      }
    },
    ...
    bower: {
      rjsConfig: '<%= yeoman.assets.javascripts %>/application.js',
      indent: '    '
    }
  });
